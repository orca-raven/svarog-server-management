...
- **Управляемый API доступ** - возможность отключения внешнего API

### ⚙️ Настройки безопасности
- **API доступ**: по умолчанию отключен, можно включить в настройках
- **Внутренний функционал**: работает независимо от настроек API
- **Внешние интеграции**: доступны только при включенном API
